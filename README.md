...
4. Edge Cases : Certain sellers avoid using brand keywords and mentions to evade delisting - essentially modifying product images to distort or hide brand logos.
...
5. Optional - Deployment and Automated Reporting using the listed platform specific policies
